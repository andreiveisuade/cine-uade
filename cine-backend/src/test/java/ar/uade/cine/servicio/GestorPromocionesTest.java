...
class GestorPromocionesTest {
    ...
    private static Entrada entrada(double precio) {
        return new Entrada(1, "A1", TipoTarifa.GENERAL, precio);
    }

    private static Entrada entrada(double precio, TipoTarifa tarifa) {
        return new Entrada(1, "A1", tarifa, precio);
    }
    ...
    void elPorcentajeDescuentaSobreElSubtotal() {
        ...
        assertEquals(3000, promo.calcularDescuento(List.of(entrada(5000), entrada(5000))), 0.001);
    }

    /** Descontar más que el total dejaría un cobro negativo. */
    @Test
    void elMontoFijoNuncaDescuentaMasQueElTotal() {
        Promocion promo = promociones.crearMontoFijo("2000 off", 2000, DESDE, HASTA,
                Set.of(), null, null, Set.of());

        assertEquals(1500, promo.calcularDescuento(List.of(entrada(1500))), 0.001);
    }
    ...
    void elDosPorUnoRegalaLaMasBarata() {
        ...
        assertEquals(4000, promo.calcularDescuento(List.of(entrada(6000), entrada(4000))), 0.001);
    }
    ...
    void elDosPorUnoSoloCuentaGruposCompletos() {
        ...
        assertEquals(5000, promo.calcularDescuento(
                List.of(entrada(5000), entrada(5000), entrada(5000))), 0.001);
    }
    ...
    void unaSolaEntradaNoActivaElDosPorUno() {
        ...
        assertEquals(0, promo.calcularDescuento(List.of(entrada(5000))), 0.001);
    }
    ...
    void ganaLaQueMasDescuenta() {
        ...
        assertEquals(5000, promociones.descuentoDe(ganadora.get(), dos), 0.001);
    }
    ...
    void laTarifaReducidaNoParticipaDelDescuento() {
        ...
        assertEquals(2500, promociones.descuentoDe(promo, mixta), 0.001,
    ...
    void laDelBancoSoloCorreConEseMedioDePago() {
        promociones.crearMontoFijo("Banco", 1000, DESDE, HASTA,
    ...
    void rechazaDosPromocionesConElMismoNombre() {
        ...
        assertThrows(IllegalArgumentException.class, () -> promociones.crearMontoFijo("30 off", 500,
                DESDE, HASTA, Set.of(), null, null, Set.of()));
    }
}
