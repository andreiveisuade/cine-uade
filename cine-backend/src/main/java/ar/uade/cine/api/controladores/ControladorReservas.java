 ...
 * pero se atiende acá y no en {@link ControladorFunciones}: es la primera etapa del
...
public class ControladorReservas {
    ...
    public ControladorReservas(GestorReservas reservas, GestorClientes clientes,
