 ...
 *
 * <p>El candy llegó a existir sin estar publicado: existía el gestor, con sus reglas y sus tests,
...
class RutasCandy {
    ...
    static void registrar(Javalin app, GestorCandy candy, GestorProductos carta,
                          GestorCaja caja, VistasCandy vistas) {
        ...
        app.get("/api/candy/arqueo", ctx -> {
            ...
            ctx.json(new ArqueoCandyVistaDTO(fecha.toString(), caja.totalCandyDe(fecha).aPesos(),
