...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GestorPromociones gestorPromociones = new GestorPromociones(promocionDAO);
        GestorPagos gestorPagos = new GestorPagos(pagoDAO, reservaDAO, funcionDAO, gestorPromociones);
