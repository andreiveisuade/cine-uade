...
import ar.uade.cine.servicio.promociones.PoliticaPromociones;
...
public class GestorPagos {
    ...
    /**
     * Los pagos de varias reservas de una sola vez. Lo usa el ensamblador del listado para
     * no pedir uno por reserva, que es una consulta por fila de la tabla.
     */
    public List<Pago> buscarPorReservas(Collection<Integer> reservaIds) {
        return pagoDAO.buscarPorReservas(reservaIds);
    }
