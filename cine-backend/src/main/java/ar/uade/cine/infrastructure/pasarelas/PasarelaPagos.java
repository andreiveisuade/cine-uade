 ...
 *
 * <p>Es una interfaz por el mismo motivo que {@link ar.uade.cine.infrastructure.comprobantes.GeneradorTicket}:
 ...
 * argumento en {@code Aplicacion} y {@link ar.uade.cine.service.ventas.GestorPagos} no se entera.
 *
...
public interface PasarelaPagos {
     ...
     * guarda en el {@link ar.uade.cine.model.ventas.Pago} y lo único que después permite
