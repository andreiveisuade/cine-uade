...
import { boton, filaTabla, panel } from "../componentes.js";
...
export async function vistaFuncion(contenedor, id) {
  ...
  contenedor.innerHTML = `
    ...
    <div class="grid gap-4 md:grid-cols-2 md:items-start">
      ${panel(dibujarBordero(bordero), "p-4", 'id="bordero"')}

      ${panel(dibujarInforme(informe), "p-4")}
    </div>
  `;
...
function dibujarBordero(bordero, emitido = false) {
  ...
  return `
    ...
    <div class="mt-4 flex flex-wrap items-center gap-3 border-t border-slate-200 pt-3 dark:border-slate-800">
      ${boton("Emitir para el INCAA", { tipo: "button", ancho: "", atributos: 'id="emitir"' })}
